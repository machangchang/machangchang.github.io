...
![](/images/blog/2018-09-16-Linkedlist/Linkedlist_01.jpg)
...
(05) 由于LinkedList实现了Deque，而Deque接口定义了在双端队列两端访问元素的方法。提供插入、移除和检查元素的方法。
...
遍历LinkedList时，使用removeFist()或removeLast()效率最高。但用它们遍历时，会删除原始数据；若单纯只读取，而不删除，应该使用第3种遍历方式。不建议通过随机访问去遍历Linkedlist。

> 参考链接：http://www.cnblogs.com/skywang12345/p/3308807.html
